...
V1.0
 ...
 This application is developed using C programming language and tested on the Teensy 3.6 microcontroller, on Windows 10, in Arduino application, under "Serial + Keyboard + Mouse + Joystick" usb type. It may(most probably) work on other 'usb type' configurations which include 'Keyboard'. It also may work on other OSes.
